...
(1, 'SCC-25-00000001', '$2y$10$l4keP.upK26yft8inNTkjesQTejbmcWQtw1uZeh2x4ar1xEKC6aDy', 'Active', 'Student'),
(2, 'SCC-25-00000001', '$2y$10$20zszjdFMQVq9GEEY/cHOeob6hY9VDqM3W6e.5lYTS6hHeb2WZ7B2', 'Active', 'Student'),
(3, 'SCC-25-00000001', '$2y$10$mZ9Q1ZD6r2qR6oqpLZPpaO1iOtYr8K6Bt1wH6N0hTovC84YCixIf2', 'Active', 'Student');
...
--
ALTER TABLE `counselors`
  ADD CONSTRAINT `counselors_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`u_id`);
...
ALTER TABLE `parents`
  ...
  ADD CONSTRAINT `parents_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`u_id`);

--
-- Constraints for table `students`
--
ALTER TABLE `students`
  ADD CONSTRAINT `students_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`u_id`);
COMMIT;
