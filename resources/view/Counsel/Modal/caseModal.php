...
<div id="editCaseModal" class="modal" style="display:none;">
    <div class="modal-content">
        ...
        <form action="../../../app/Controllers/Counsel/CaseController/editcase.php" method="POST">
            ...
            <div class="form-group">
                <label for="case_type">Case Type:</label>
                <select id="edit_case_type" name="case_type" required>
                    <option value="">Select Case Type</option>
                    <option value="Behavioral">Behavioral</option>
                    <option value="Emotional">Emotional</option>
                    <option value="Peer Conflict">Peer Conflict</option>
            ...
            <div class="form-group">
                <label for="referred_by">Referred By:</label>
                <input type="text" id="edit_referred_by" name="referred_by" >
            </div>
            <div class="form-group">
                <label for="referral_date">Referral Date:</label>
                <input type="date" id="edit_referral_date" name="referral_date" >
            </div>
            <div class="form-group">
                <label for="reason_for_referral">Reason for Referral:</label>
                <input type="text" id="edit_reason_for_referral" name="reason_for_referral" >
            </div>
            <div class="form-group">
                <label for="presenting_problem">Presenting Problem:</label>
                <input type="text" id="edit_presenting_problem" name="presenting_problem" >
            </div>
            <div class="form-group">
                <label for="observe_behavior">Observed Behavior:</label>
                <textarea id="edit_observe_behavior" name="observe_behavior" ></textarea>
            </div>
            <div class="form-group">
                <label for="family_background">Family Background:</label>
                <input type="text" id="edit_family_background" name="family_background" >
            </div>
            <div class="form-group">
                <label for="academic_history">Academic History:</label>
                <input type="text" id="edit_academic_history" name="academic_history" >
            </div>
            <div class="form-group">
                <label for="social_relationships">Social Relationships:</label>
                <input type="text" id="edit_social_relationships" name="social_relationships" >
            </div>
            <div class="form-group">
                <label for="medical_history">Medical History:</label>
                <input type="text" id="edit_medical_history" name="medical_history" >
            </div>
            <div class="form-group">
                <label for="counselor_assessment">Counselor Assessment:</label>
                <textarea id="edit_counselor_assessment" name="counselor_assessment" ></textarea>
            </div>
            <div class="form-group">
                <label for="recommendations">Recommendations:</label>
                <textarea id="edit_recommendations" name="recommendations" ></textarea>
            </div>
            <div class="form-group">
                <label for="follow_up_plan">Follow-Up Plan:</label>
                <textarea id="edit_follow_up_plan" name="follow_up_plan" ></textarea>
            </div>
            <div class="form-group">
                <label for="status">Status:</label>
