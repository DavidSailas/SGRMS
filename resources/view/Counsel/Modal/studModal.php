...
<div id="addStudentModal" class="modal">
    <div class="modal-content">
        ...
        <form id="addStudentForm" method="POST" action="../../../app/Controllers/Counsel/StudentController/addstud.php" enctype="multipart/form-data">
...
<div id="editStudentModal" class="modal">
    <div class="modal-content">
        ...
        <form id="editStudentForm" method="POST" action="../../../app/Controllers/Counsel/StudentController/editstud.php" enctype="multipart/form-data">
...
fetch('../../../app/Controllers/Counsel/StudentController/getstudNum.php')
    .then(response => {
